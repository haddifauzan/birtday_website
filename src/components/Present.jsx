...
function Present() {
  return (
    <SectionWrapper>
      <div className='mb-64'>
        <h1 className="absolute -top-[7rem] left-0 right-0 text-center flex items-center justify-center text-xxl font-extrabold text-customBlue drop-shadow-lg">
        ...
        <label className='gift' htmlFor='click'>
          ...
          <div id="raffle-red" className="entry raffle raffle-1">
            <div className="no-scale">
              <span className="ticket-text">Free<br/>Watch</span>
            </div>
          </div>
          <div id="raffle-red" className="entry raffle raffle-2">
            <div className="no-scale">
              <span className="ticket-text">Free<br/>Play</span>
            </div>
          </div>
